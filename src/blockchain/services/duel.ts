...
export class DuelApiService {
    ...
    public async createDuelByAdmin (firstPlayerId: string) : Promise<string | null> {
    ...
    public async AddOpponentByAdmin (duelId: string, secondPlayerId: string): Promise<boolean> {
        return new Promise((resolve, reject) => {
            const signature: string = GetSignedAuthMessage();
