...
export type ShopItemData = {
  id: number,
  type:
    'instant' // applied immediately and does not remain in the player's slots.
  | 'permanent', // placed in the player's slots and is valid while it is there.
  name: string,
  description: string,
  icon: string,
  price: number
